...
RUN R -e "install.packages('BiocManager')" \
 ...
 && R -e "stopifnot(all(sapply(c('minfi','wateRmelon','IlluminaHumanMethylationEPICanno.ilm10b4.hg19','IlluminaHumanMethylationEPICv2anno.20a1.hg38'), requireNamespace, quietly=TRUE)))"